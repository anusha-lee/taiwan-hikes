...
function displayTrips() {
  ...
  let upToDateTrips = guidedTrips.filter(trip => {
    return Date.parse(trip.date) > today;
  });
    ...
    allTrips.innerHTML += `
          <div class="eachTrip">
            ...
            <div class="eachTrip__box">          
              ...
              <div class="eachTrip__box--cost"><strong>Cost: ${trip.cost}</strong></div>
  ...
  allBtn.addEventListener("click", event => {
    ...
    upToDateTrips.forEach(trip => {
      ...
      ratingColor.forEach(checkColor => {
        if (trip.difficultyLevel === "A") {
          checkColor.classList.replace(
            "eachTrip__color-rating",
            "rating-green"
          );
        } else if (trip.difficultyLevel === "B") {
          checkColor.classList.replace(
